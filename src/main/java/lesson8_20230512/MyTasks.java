package lesson8_20230512;

import lesson7_20230505.Cat;
...
//    integers.stream()
//            .mapToInt(value -> value).filter(value -> value % 2 != 0).sum();
...
//            .collect(Collectors.partitioningBy(el -> (el % 3 == 0), Collectors.toList()));
    ...
    return IntStream.range(0, 100)
            .boxed()
            .collect(Collectors.groupingBy(e -> e % 3 == 0, Collectors.mapping(t -> t, Collectors.toList())));

//    Map<Boolean, List<Integer>> collect = IntStream.range(0, 100)//rangeClosed include 100
//            .boxed()
//            .collect(Collectors.toMap(e -> e, e -> e % 3 == 0))
//            .entrySet()
//            .stream()
